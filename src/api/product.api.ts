...
import { GetProductsResponse, DeleteProductResponse, AddProductResponse, AddProduct as AddProductType, UpdateProductType } from "./types";
...
const UpdateProduct = async (id: string, data: UpdateProductType) => axios.put<Product>(`${backendUrl}products/${id}`, data);
const GetAllCategories = async () => axios.get(`${backendUrl}products/categories`);

export { GetAllProducts, DeleteProduct, AddProduct, GetProduct, UpdateProduct, GetAllCategories }